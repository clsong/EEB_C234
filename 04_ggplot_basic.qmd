...
Let us load the `penguins` dataset from the `palmerpenguins` package, as we learnt last week.
```{r}
...
- The `+` operator is used to add layers to the plot. This is a common pattern in `ggplot2`.
...
### Exercise 1: A straightforward plot
...
### Exercise 2: Why you always need to plot your data. 
