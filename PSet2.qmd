...
Welcome to your second problem set! In this assignment, you will import and tidy ecological data to perform exploratory analyses. We will replicate parts of the analysis from a recent paper linking ecology and evolution. You can read the paper [here](https://www.nature.com/articles/s41467-022-30090-4). 

## What to Turn In

- Submission Package: A folder (or zip file) that contains:
  - Your complete RStudio project.
  - Your code for data wrangling and analysis.
  - The two final publication-quality figures.
...
2. Data Import
    ...
    - Load the Data: Import both CSV files into R. You can use `read_csv()`.
...
7. Create One More Publication-Quality Figure:
   ...
   - Explpre another interesting relationship or distribution in your data.
   - Use what you have learned in the class to make the figure more informative and aesthetically pleasing.
