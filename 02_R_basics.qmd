...
However, AIs can be unreliable sometimes. To make sure it works, you can always use the `?` to get help. For example, to get help on the `sqrt()` function, you can use the following code:
```{webr}
?sqrt
```
